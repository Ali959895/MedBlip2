...
#        OPT_PATH = "/scratch/ali95/models/opt-2.7b"
#
#
#        self.opt_tokenizer = AutoTokenizer.from_pretrained(OPT_PATH, use_fast=False)
#        self.opt_model = OPTForCausalLM.from_pretrained(
#            OPT_PATH, torch_dtype=torch.float16,local_files_only=True
#        )
        OPT_PATH = opt_model
    ...
    def forward(self, samples):
        ...
        embed_tokens = opt_model.get_input_embeddings()

        inputs_embeds = embed_tokens(opt_tokens.input_ids)
