#!/bin/bash
#SBATCH --job-name=LC25000_v3_mix
...
# ====== Project paths ======
PROJ=/scratch/ali95/LC250000_finetuning_v3
CFG_BLIP2=${PROJ}/configs/LC25000_finetune.yaml
CFG_BLIP=${PROJ}/configs/LC25000_blip.yaml
